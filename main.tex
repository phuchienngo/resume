...
%--------PROGRAMMING SKILLS------------
    ...
    \resumeSubHeadingListStart
    \item{
        \textbf{Languages}{: Java, Kotlin, Python, JavaScript, SQL}
        \hfill
        \textbf{Technologies}{: Vert.x, gRPC, Bigtable, HBase, BigQuery, Firestore, MongoDB, Cloud Pubsub, Kafka, Redis, DragonflyDB, PostgreSQL}
    }
    \resumeSubHeadingListEnd
